    ...
    <nav className="fixed top-0 w-full z-50 bg-surface/80 backdrop-blur-xl border-b border-outline-variant/20 shadow-[0_40px_40px_-15px_rgba(0,70,74,0.04)]">
      <div className="max-w-7xl mx-auto px-4 md:px-12 h-16 md:h-24 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8 lg:gap-12">
          <a
            className="font-display-md tracking-wide uppercase text-sm font-medium text-primary border-b border-primary/50 pb-1 transition-transform duration-700 hover:scale-105"
            href="#"
          >
            Expérience
          </a>
          <a
            className="font-display-md tracking-wide uppercase text-sm font-medium text-on-surface-variant hover:text-primary transition-all duration-500 hover:scale-105"
            href="#"
          >
            Services
          </a>
        ...
        <button className="md:hidden p-2 -mr-2 text-primary" aria-label="Menu">
    ...
    <footer className="w-full py-12 md:py-16 lg:py-24 mt-16 md:mt-24 lg:mt-32 bg-surface-container border-t border-outline-variant/20">
      <div className="max-w-7xl mx-auto px-4 md:px-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 lg:gap-16">
        <div className="space-y-4 md:space-y-6">
          <div className="font-display-md italic text-xl text-primary">
            QUINTESSENCE
          </div>
          <p className="font-body-lg text-sm leading-relaxed text-on-surface-variant">
